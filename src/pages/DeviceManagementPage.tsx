...
const API_BASE_URL = 'https://api-device-evaluation.domusduo.space/api/v1';
...
export function DeviceManagementPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const payload: Device = {
                ...
                specificPricingPolicies: (formData.specificPricingPolicies || []).map(p => ({
                    saleMode: p.saleMode,
                    paymentTiming: p.paymentTiming,
    ...
    useEffect(() => {
        ...
        if (isDamageTypeModalOpen || isPricingModalOpen || isModalOpen) {
    ...
    }, [isDamageTypeModalOpen, isPricingModalOpen, isModalOpen]);
